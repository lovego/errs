...
github.com/lovego/errs.Stack
	(/.+/src/github\.com/lovego/errs/stack\.go:13|` +
		`github\.com/lovego/errs/_test/_obj_test/stack\.go:14) \(0x[a-z0-9]+\)
...
github.com/lovego/errs.ExampleWithStack
	/.+/src/github.com/lovego/errs/stack_test\.go:28 \(0x[a-z0-9]+\)
`)
	if !re.MatchString(stack) {
		fmt.Println(stack)
	}
